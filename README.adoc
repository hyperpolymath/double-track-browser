...
This project declares **MPL-2.0-or-later** — see `LICENSE` for the full text.
...
* ✅ *Type Safety*: Rust compile-time guarantees + AffineScript type system
...
- *AffineScript* instead of TypeScript
